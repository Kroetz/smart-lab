...
public class MeetingId extends AbstractIdentifier {
    ...
    CALENDAR (i.e. per room in the terms of Smart Lab) basis. That means that calls to the API of such an repository
    implementation generally require an meeting ID and a room/calendar ID. To prevent adopting the API of Smart Lab to
    the API of some external provider the room ID was embedded into the meeting ID class.
     */

    private static final String ID_PART_DELIMITER = "_";

    private final String nameIdPart;
    private final RoomId locationIdPart;
    ...
    private MeetingId(String composedIdValue) {
        ...
        this.locationIdPart = RoomId.of(idParts[1]);
    }

    private MeetingId(String nameIdPart, RoomId locationIdPart) {
    ...
    public static MeetingId of(String nameIdPart, RoomId locationIdPart) {
