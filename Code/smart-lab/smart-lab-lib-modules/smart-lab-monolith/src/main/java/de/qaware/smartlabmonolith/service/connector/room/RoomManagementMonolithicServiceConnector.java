...
public class RoomManagementMonolithicServiceConnector extends AbstractBasicEntityManagementMonolithicServiceConnector<IRoom, RoomId> implements IRoomManagementService {

    private final RoomManagementController roomManagementController;

    public RoomManagementMonolithicServiceConnector(RoomManagementController roomManagementController) {
