package de.qaware.smartlabaction.action.executable.speechtotext.remeeting;

import de.qaware.smartlabaction.action.externalapi.remeeting.IRemeetingApiClient;
