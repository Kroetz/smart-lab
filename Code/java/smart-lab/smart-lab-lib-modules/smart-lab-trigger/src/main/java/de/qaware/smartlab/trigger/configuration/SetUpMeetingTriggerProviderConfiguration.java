...
import static de.qaware.smartlab.trigger.provider.setupmeeting.SetUpMeetingCallbackController.MAPPING_CALLBACK;

@Configuration
@ComponentScan(basePackageClasses = {
        de.qaware.smartlab.trigger.provider.setupmeeting.ComponentScanMarker.class})
@EnableSmartLabCore
@EnableSmartLabApi
