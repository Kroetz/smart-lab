package de.qaware.smartlabaction.action.windowhandling.configuration;

import de.qaware.smartlabaction.action.windowhandling.windowhandler.LinuxWindowHandler;
import de.qaware.smartlabaction.action.windowhandling.windowhandler.WindowsWindowHandler;
...
public class WindowHandlerConfiguration {
    ...
    // TODO: String literal
    @ConfigurationProperties(prefix = "delegate", ignoreInvalidFields = true)
    @Validated
