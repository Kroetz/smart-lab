...
public abstract class MeetingManagementApiConstants {
    ...
    public static final String FEIGN_CLIENT_NAME = "smart-lab-meeting-microservice";
    ...
    public static final String MAPPING_FIND_ALL_BY_LOCATION_ID = PATH_FRAGMENT_MEETINGS + "/all" + PATH_FRAGMENT_AT_LOCATION + "/{" + PARAMETER_NAME_LOCATION_ID + "}";
    ...
    public static final String MAPPING_FIND_CURRENT_BY_LOCATION_ID = PATH_FRAGMENT_MEETING + "/current" + PATH_FRAGMENT_AT_LOCATION + "/{" + PARAMETER_NAME_LOCATION_ID + "}";
